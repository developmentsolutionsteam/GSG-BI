...
CANTIDAD AS (
    ...
    FROM INV_ONHAND_QUANTITIES_DETAIL Q --,ARTICULOS ART
,
    ...
    WHERE 1 = 1
        AND ARTGP.ORGANIZATION_ID = Q.ORGANIZATION_ID (+)
        AND ARTGP.INVENTORY_ITEM_ID = Q.INVENTORY_ITEM_ID (+)
...
,
    ...
    WHERE 1 = 1
        ...
        AND CPC.VAL_UNIT_ID = ULT_COST.VAL_UNIT_ID --CUENTA CONTABLE
        AND CSTXLA.TRANSACTION_ID = CPC.TRANSACTION_ID --CT.TRANSACTION_ID
...
SELECT ART.*,
    ...
    ROUND((CA.CANTIDAD * CT.COSTO_TOTAL), 3) VALOR_TOTAL,
    CT.COST_DATE,
...
WHERE 1 = 1
    ...
    AND ART.INVENTORY_ITEM_ID = CT.INVENTORY_ITEM_ID (+)WITH ARTICULOS AS (
    SELECT A.ORGANIZATION_CODE,
        B.NAME ORGANIZATION,
        INV.ITEM_NUMBER ITEM,
        INV.DESCRIPTION DESCRIPTION_ITEM,
